...
export default function Story() {
  return (
    <section id="story" data-verify="story" className="relative z-10">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -top-[390px] left-1/2 h-[1496px] w-[2155px] -translate-x-1/2 -scale-y-100 bg-[url(/images/story-ellipse.svg)] [background-size:100%_100%] min-[1470px]:[mask-image:linear-gradient(to_right,transparent_14%,black_34%,black_66%,transparent_86%)]"
      />
